...
class showinfo(_Dialog):
    ...
    def make_Label_1(self, frame):
        ...
        self.Label_1 = Label( frame , text="Title", width="15", font="Helvetica 20 bold roman")
...
class _Testdialog:
    ...
    def Button_1_Click(self, event): #click method for component ID=1
        dialog = showinfo(self.master, "Test Dialog", dialogOptions={'info':INFO})
