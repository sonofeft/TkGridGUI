...
class _example:
    def __init__(self, master):
        ...
        self.x, self.y, self.w, self.h = 10, 10, 425, 151
        ...
        self.statusMessage.set("Welcome to example")
    ...
    def make_Button_2(self, frame):
        """      Button: Say Hello : at Main(3,1)"""
        self.Button_2 = Button( frame , text="Say Hello", width="15")
    ...
    def make_Entry_2(self, frame):
        ...
        self.Entry_2.grid(row=5, column=2)
    ...
    def make_Label_1(self, frame):
        """       Label: My dog has fleas : at Main(6,3)"""
        self.Label_1 = Label( frame , text="My dog has fleas", width="15")
        self.Label_1.grid(row=6, column=3)
    ...
    def make_Label_2(self, frame):
        """       Label: Now is not the time for barking : at Main(7,3)"""
        self.Label_2 = Label( frame , text="Now is not the time for barking", width="30")
        self.Label_2.grid(row=7, column=3)
