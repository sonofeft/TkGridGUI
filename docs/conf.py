...
# -*- coding: utf-8 -*-
#
# TkGridGUI documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'tkgridgui','_version.py')
...
htmlhelp_basename = 'TkGridGUIdoc'
...
latex_documents = [
  (master_doc, 'TkGridGUI.tex', u'TkGridGUI Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'TkGridGUI Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'TkGridGUI', u'TkGridGUI Documentation',
   author, 'TkGridGUI', 'One line description of project.',
   'Miscellaneous'),
]
